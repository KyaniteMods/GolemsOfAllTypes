...
import com.kyanite.goat.registry.blocks.custom.MetalButtonBlock;
...
public class GTBlocks {
    public static final Supplier<ButtonBlock> COPPER_BUTTON = registerBlock("copper_button", true, () -> new MetalButtonBlock(BlockBehaviour.Properties.copy(Blocks.OAK_BUTTON)));
